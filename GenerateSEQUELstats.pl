	...
	my %PROGRAM;
	$PROGRAM{'name'}	= "GenerateSEQUELstats.pl";
	$PROGRAM{'version'}	= "190417A";
	...
	parse_LQ_data($PARAMS{'Hn'}, \%g_LQdata);
	parse_MQ_data($PARAMS{'HpSn'}, \%g_MQdata);
	parse_HQ_data($PARAMS{'HpSp'}, \%g_HQdata, \@g_hist);
